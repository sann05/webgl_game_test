...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/WEBGL_BigZ.loader.js";
var config = 
{
  dataUrl: buildUrl + "/67f9ef4077c6069d9305f3cd4e95a54d.data.unityweb",
...
if (/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)) 
{
  ...
  var width = Math.min(window.innerWidth, 1080);
